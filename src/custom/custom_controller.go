...
type custom_controller struct {
	...
	configMapLister       listers_core_v1.ConfigMapLister
	workQueue             workqueue.RateLimitingInterface
	configMapCacheSynced  cache.InformerSynced
}

func CustomController(clientset kubernetes.Interface, configMapInformer informers_core_v1.ConfigMapInformer) *custom_controller {
